sap.ui.define([
	...
	"Bcsoft/Candidate/model/formatter",
	"sap/ui/model/Filter",
	...
	return BaseController.extend("Bcsoft.Candidate.controller.Candidatelist", {
		...
		onUnlistObjects: function() {
			...
			if (aSelectedProducts.length) {
				...
				this._showErrorMessage('Выберите удаляемых кандидатов');
			}
		},
